...
static const struct option long_options [] =
{
    ...
    { "serial-zoom",                    required_argument, NULL, 175},
    { "serial-focus",                   required_argument, NULL, 176},
    { "serial-iris",                    required_argument, NULL, 177},
...
int instance_opts(instance_t* instance, int argc, char** argv)
{
    ...
    while(1)
    {
        ...
        switch(c)
        {
            ...
            case 175:   /* --serial-zoom */
                ST_STR(serials[LENS_PARAM_ZOOM], PATH_MAX);

            case 176:   /* --serial-focus */
                ST_STR(serials[LENS_PARAM_FOCUS], PATH_MAX);

            case 177:   /* --serial-iris */
                ST_STR(serials[LENS_PARAM_IRIS], PATH_MAX);
